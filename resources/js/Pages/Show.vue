<template>
    <app-layout>
        <template #header>
            <h1 class="text-center text-2xl font-bold leading-7 text-gray-300 sm:text-3xl sm:truncate py-4 bg-gradient-to-l from-indigo-500 to-indigo-800 ">SHOW PRODUCTS</h1>
        </template>
                    ...
                    <table class="rounded-t-lg mt-5 min-w-full mx-auto bg-gray-800 text-gray-100">
                        ...
                        <tbody class="bg-gray-700 border-b border-gray-600 text-gray-200">
                            <tr v-for="product in products" :key="product.id">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm"><span>€ </span>{{ product.price }}</div>                    
                                </td>
